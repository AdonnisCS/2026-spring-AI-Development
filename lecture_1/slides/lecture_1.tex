...
\begin{itemize}
    ...
    \end{enumerate}
    \item System Understanding: By learning how to use these systems via API we will understand better how agentic workflows \it{actually} work.
\end{itemize}
\end{frame}

\begin{frame}{Example: Personalized Marketing Outreach}
\begin{itemize}
    \item A company wants to connect their email and sales system to send personalized coupons.
    \item They need to write code to:
    \begin{itemize}
        \item Connect to their sales database
...
\begin{enumerate}
    ...
    \end{itemize}
    \item \textbf{Understand the Agent Loop}
\end{enumerate}
\end{frame}
...
\begin{itemize}
    ...
    \item Dates: TuTh this week and next
...
\begin{frame}{Context windows: What are they}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Common model context windows:
\item Common model context windows:
    \begin{itemize}
        \item \textbf{GPT-5.4}: 272,000 tokens (standard), expandable to 1,000,000 via API
        \item \textbf{Claude Sonnet 4.6}: 1,000,000 tokens
        \item \textbf{Claude Opus 4.6}: 1,000,000 tokens
        \item \textbf{Gemini 3.1 Pro}: 1,000,000 tokens
        \item \textbf{Llama 4 Scout}: 10,000,000 tokens
...
\begin{itemize}
\item Team up with another person (min group 2, max group 4)	
\item Get access to your API Keys	
\item Verify that you can use the keys
\item Complete the notebook by answering the following questions:
\begin{itemize}
\item How did the different models perform?
\item What are your take-aways?
\end{itemize}
\end{itemize}
\end{frame}
